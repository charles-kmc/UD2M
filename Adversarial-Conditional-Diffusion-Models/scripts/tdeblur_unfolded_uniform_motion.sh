...
python3 main.py --task "deblur" --operator_name "uniform_motion" --lambda_ 0.5 --config_file "fine_tuning_lmodel.yaml" > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
