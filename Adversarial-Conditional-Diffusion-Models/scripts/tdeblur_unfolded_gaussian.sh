...
python3 main.py --task "deblur" --operator_name "gaussian" --lambda_ 0.3 --config_file "fine_tuning_lmodel.yaml" > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
