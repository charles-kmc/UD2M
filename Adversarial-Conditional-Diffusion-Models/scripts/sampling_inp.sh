...
python3 main_sample_conditional.py --task "inp" --operator_name "random" --lambda_ 0.0005 --ckpt_epoch 99 --sigma_model 0.05 --ckpt_date "02-03-2025" --config_file "fine_tuning_lmodel.yaml" --total_steps 5 > "$RESULTS_DIR"_out_sample_dif.output 2> "$RESULTS_DIR"_err_sample_dif.error
