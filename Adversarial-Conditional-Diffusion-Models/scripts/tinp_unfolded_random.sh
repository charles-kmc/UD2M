...
# python3 main.py --task "inp" --operator_name "box" --lambda_ 0.001 --config_file "fine_tuning_lmodel.yaml" > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
python3 main.py --task "inp" --operator_name "random" --lambda_ 0.001 --config_file "fine_tuning_lmodel.yaml" > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
# Final message
echo "Finish!!"
