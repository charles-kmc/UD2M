...
- Inpainting
    ...
    - python3 main_sample_conditional.py --task "inp" --operator_name "random" --cd  1000 --ckpt_epoch 300 --ckpt_date "07-12-2024"


New 
python3 main_sample_conditional.py --task "deblur" --operator_name "gaussian" --lambda_ 0.3 --ckpt_epoch 129 --ckpt_date "11-03-2025" --config_file "fine_tuning_lmodel.yaml" --total_steps 10 --sigma_model 0.05