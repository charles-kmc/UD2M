...
python3 main.py --task "sr" --operator_name "gaussian" --lambda_ 1 --config_file "fine_tuning_lmodel.yaml" > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
