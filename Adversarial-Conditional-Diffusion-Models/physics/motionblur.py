...
class Kernel(object):
    ...
    def __init__(self, size: tuple = (100, 100), intensity: float=0, rng=None): 
        if rng is None:
    ...
    def _createPath(self):
        ...
        def getSteps():
            ...
            and each step: self.rng.beta(1, 30) * (1 - self.INTENSITY + eps) * diagonal)
            """
        ...
        def getAngles():
            ...
            We sample "jitter" from a self.rng.beta(2,20) which is the probability
