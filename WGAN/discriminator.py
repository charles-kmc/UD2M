...
from WGAN.shared import ResidualBlock, FullyConnectedLayer
from WGAN.vit_utils import make_vit_backbone, forward_vit
...
class DiscHead(nn.Module):
    def __init__(self, channels: int, cmap_dim: int = 64):
        super().__init__()
...
class ProjectedDiscriminator(nn.Module):
    def __init__(self, p_crop: float = 0.5):
        super().__init__()
        self.p_crop = p_crop
