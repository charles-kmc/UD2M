...
def configs(mode="train"):
    ...
    parser.add_argument("--max_unfolded_iter", type=int, default=3, help="Number of unfolded iterations")
    ...
    parser.add_argument("--use_RAM", type=bool, default=False, help="Whether to initialize unfolded loop using RAM or not")
