...
python3 main_sample_conditional.py --task "sr" --operator_name "gaussian" --lambda_ 1 --ckpt_epoch 300  --sigma_model 0.05  --ckpt_date "11-01-2025" > "$RESULTS_DIR"_out_sample_dif.output 2> "$RESULTS_DIR"_err_sample_dif.error
