...
#---------------------------
RESULTS_DIR1="/users/cmk2000/cmk2000/Deep learning models/LLMs/logs/Logger_${SLURM_JOB_NAME}"
...
python3 main_sample_conditional.py --task "deblur" --operator_name "gaussian" --lambda_ 0.7 --ckpt_epoch 60  --sigma_model 0.05  --ckpt_date 19-01-2025 > "$RESULTS_DIR"_out_sample_dif.output 2> "$RESULTS_DIR"_err_sample_dif.error
