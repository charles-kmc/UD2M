...
python3 main_unfolded_training.py --task "deblur" --operator_name "uniform_motion" --lambda_ 0.7 > "$RESULTS_DIR"_out_train_dif.output 2> "$RESULTS_DIR"_err_train_dif.error
