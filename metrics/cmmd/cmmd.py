...
def compute_cmmd(ref_dir, eval_dir, batch_size = 4, max_count = -1):
...
def main_cmmd(dir1, dir2, name_log):
  # Create logger
  ...
  log_file = os.path.join(log_dir, name_log)
  ...
  cmmd_val = compute_cmmd(dir1_new, dir2_new, BATCH_SIZE, MAX_COUNT)
