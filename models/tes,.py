...
class MixedPrecisionTrainer:
    def __init__(
        ...
        self.model_params_learned = list(filter(lambda p: p.requires_grad, self.model.parameters())) #list(self.model.parameters())
        self.model_params = list(self.model.parameters())
        self.master_params = self.model_params
        self.master_params_learned = self.model_params_learned
    ...
    def _compute_norms(self, grad_scale=1.0):
        grad_norm = 0.0
        param_norm = 0.0
        for p in self.master_params_learned:
            with torch.no_grad():
